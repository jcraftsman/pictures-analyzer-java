...
class AnalyzerTest {
    ...
    private static final ClassLoader CLASS_LOADER = AnalyzerTest.class.getClassLoader();
    private static final String PICTURES_DIRECTORY_PATH = CLASS_LOADER.getResource("pictures").getFile();
